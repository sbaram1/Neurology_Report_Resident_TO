...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{table}\NormalTok{(db}\OperatorTok{$}\NormalTok{DQ3_}\DecValTok{1}\NormalTok{_전공의_연차, db}\OperatorTok{$}\NormalTok{DQ1_Sepcialty)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{meanworkhour =} \KeywordTok{mean}\NormalTok{(A1_}\DecValTok{1}\NormalTok{_worktime_weekday, }\DataTypeTok{na.rm =}\NormalTok{ T),}
            \DataTypeTok{maxworkhour =} \KeywordTok{max}\NormalTok{(A1_}\DecValTok{1}\NormalTok{_worktime_weekday, }\DataTypeTok{na.rm =}\NormalTok{ T),}
            \DataTypeTok{minworkhour =} \KeywordTok{min}\NormalTok{(A1_}\DecValTok{1}\NormalTok{_worktime_weekday, }\DataTypeTok{na.rm =}\NormalTok{ T))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{Neurology_Report_Resident_TO_files/figure-latex/unnamed-chunk-13-1.pdf}
...
\includegraphics{Neurology_Report_Resident_TO_files/figure-latex/unnamed-chunk-13-2.pdf}
...
\includegraphics{Neurology_Report_Resident_TO_files/figure-latex/unnamed-chunk-13-3.pdf}
...
\includegraphics{Neurology_Report_Resident_TO_files/figure-latex/unnamed-chunk-13-4.pdf}
